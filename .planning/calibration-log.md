...
- **Cumulative Wave-D process gaps: 4 total.** iter-2-patch propagation (nwrp124, nwrp128, nwrp129) + precursor-violation scan (nwrp130). Pattern: corrective waves need stronger pre-execute infrastructure validation than the planning protocol currently mandates. Wave-B will compound this if uncorrected — 9 plans × 2-3 weeks × foundational schema = more surface area for precursor + propagation gaps.
