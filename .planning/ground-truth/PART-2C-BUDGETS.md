...
So the −$224,906.77 is an **artifact of missing line attribution, not real over-billing** — Jake's read confirmed. **Source-side confirmation (nwrp281 A6c):** Diane's Adjusted workbook independently shows the four uncoded rows carrying **$319,571.01** of previous billings — closing the Q2/F8 hypothesis chain from both ends. Dewberry's $58,000 gap closed under the same lineage (PART 3: Urns + Generator). The cover-level numbers (contract, net COs, prior certificates) imported correctly; the line-level base was short $479,900 scheduled / $319,571.01 previous.
