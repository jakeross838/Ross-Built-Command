...
//
// Billing settings at /admin/billing — REAL-LOGIC mount of /settings/billing
// logic. Per Stage 1.5c Plan 6 + iter-2 mechanical #10: getCurrentMembership
// preserved verbatim (grep diff zero vs /settings/billing/page.tsx).
//
// Middleware billing-gate redirect destination is already /admin/billing per
// the iter-2 mechanical #4 update — this path is canonical.
//
// Re-uses BillingActions client component from /settings/billing.
    ...
    <div className="space-y-6">
      ...
      {onTrial && !currentSub && (
        <section className="bg-[rgba(91,134,153,0.12)] border border-[var(--nw-stone-blue)] p-6">
          ...
          <Link
            href="/pricing"
            className="mt-4 inline-block px-5 py-2.5 bg-[var(--nw-stone-blue)] text-nw-white-sand text-[13px] tracking-[0.08em] uppercase hover:bg-[var(--nw-gulf-blue)] transition-colors"
          >
            Compare Plans
          </Link>
        </section>
