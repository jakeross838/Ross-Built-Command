  ...
  return (
    ...
    >
      {TAB_ORDER.map((t) => {
        ...
        const href = t.key === "items" ? "/platform-admin/cost-intelligence" : `/platform-admin/cost-intelligence?tab=${t.key}`;
        return (
          <Link
            key={t.key}
            href={href}
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-2">
                    <Link
                      href={`/platform-admin/items/${it.id}`}
          ...
          {rows.length === 0 ? (
            ...
            rows.map((r) => (
              <tr key={r.id} className="border-b border-[var(--border-default)] last:border-b-0">
                ...
                <td className="px-3 py-2">
                  <Link
                    href={`/platform-admin/items/${r.item_id}`}
                    className="text-[var(--text-primary)] hover:text-nw-gulf-blue hover:underline"
                  >
